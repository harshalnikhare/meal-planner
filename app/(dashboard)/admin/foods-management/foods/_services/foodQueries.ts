...
const getFoods = async (
  ...
  if (numericMaxCalories !== undefined || numericMaxCalories !== undefined) {
    where.calories = {};
  ...
  if (numericMaxProtein !== undefined || numericMaxProtein !== undefined) {
    where.protein = {};

    if (numericMaxProtein !== undefined) where.protein.gte = numericMinProtein;
